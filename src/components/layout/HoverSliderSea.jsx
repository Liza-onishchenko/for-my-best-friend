...
import css from "../../css/AdultLife/HoverSliderSea.module.css";
import { FaChevronLeft, FaChevronRight } from "react-icons/fa";

const HoverSliderSea = ({ images, onImageClick }) => {
  ...
  return (
    <div className={css.hoverSliderSeaContainer} ref={containerRef}>

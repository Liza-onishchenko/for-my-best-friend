...
const loveStoryEvents = [
  ...
  },
  {
    ...
    description:
      "Подорож до Португалії стала для тебе першим відпочинком за кордоном і знайомством із родиною Паші. Найяскравішим моментом було плавання з дельфіном 🐬 — здійснення твоєї мрії. Ця поїздка допомогла тобі із Пашою краще пізнати одне одного та зрозуміти, як розвивати ваші стосунки.🌞🏖️",
